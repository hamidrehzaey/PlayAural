...
farkle-desc-min-entrance-score = Điểm lượt tối thiểu cần có để chốt điểm đầu tiên của người chơi. Mức này không được cao hơn mốc điểm thắng (mặc định 50, phạm vi 0-5000).
...
farkle-desc-min-bank-score = Điểm lượt tối thiểu cần có trước khi được Chốt điểm sau khi người chơi đã vào bảng điểm. Mức này không được cao hơn mốc điểm thắng (mặc định 30, phạm vi 0-5000).
