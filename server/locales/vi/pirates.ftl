...
pirates-desc-combat-xp-multiplier = Điều chỉnh XP từ phát đại bác trúng đích và lần phòng thủ thành công (mặc định 1.0, phạm vi 0.1-3.0). Hệ số Trăng Vàng được áp dụng riêng.
