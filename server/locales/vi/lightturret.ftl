...
lightturret-desc-starting-power = Công suất quá tải ban đầu của mỗi tháp pháo. Quang năng bằng công suất vẫn an toàn; chỉ khi vượt công suất mới bị quá tải (mặc định 10, phạm vi 5-30).
...
lightturret-desc-max-rounds = Số vòng trọn vẹn của trận đấu. Mỗi tháp pháo còn hoạt động đều được hành động một lần trong vòng cuối (mặc định 50, phạm vi 10-200).
