...
ninetynine-desc-starting-tokens = How many survival tokens each Ninety Nine player begins with. A player is eliminated after losing all tokens (default 9, range 1-50).
