...
pirates-desc-combat-xp-multiplier = Scales XP from cannon hits and successful defenses (default 1.0, range 0.1-3.0). The Golden Moon multiplier is applied separately.
