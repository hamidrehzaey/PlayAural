...
twentyone-desc-base-bet = Base damage dealt to the round loser before Change card adjustments (default 1, range 0-50). If set to 0, the setup must still create damage through Change cards or draw chances.
...
twentyone-desc-deck-count = How many copies of the 1-through-11 deck are shuffled each round (default 1, range 1-10). One deck means 11 cards total.
