...
twentyone-target-selection-invalid = That target is no longer available. Open the Change Card menu and choose a current opponent.
...
twentyone-desc-starting-health = How much health each 21 player has at the start of the match (default 10, range 1-100).
...
twentyone-desc-base-bet = Base damage dealt to the round loser before Change card adjustments. If set to 0, the setup must still create damage through Change cards or draw chances (default 1, range 0-50).
...
twentyone-desc-starting-modifiers-per-round = How many random Change cards each player receives at the start of each 21 round (default 1, range 0-10).
...
twentyone-desc-draw-modifier-chance-percent = Percent chance that hitting also grants a random Change card (default 35%, range 0-100).
...
twentyone-desc-deck-count = How many copies of the 1-through-11 deck are shuffled each round. One deck means 11 cards total (default 1, range 1-10).
...
twentyone-error-draw-between-rounds = You cannot draw right now because the current round is resolving or the next round has not started yet.
twentyone-error-draw-eliminated = You cannot draw because you have been eliminated from this match.
twentyone-error-draw-not-your-turn = You cannot draw during { $player }'s turn. Wait until the turn reaches you.
twentyone-error-draw-no-active-turn = You cannot draw because 21 has no active turn right now.
twentyone-error-stand-between-rounds = You cannot stand right now because the current round is resolving or the next round has not started yet.
twentyone-error-stand-eliminated = You cannot stand because you have been eliminated from this match.
twentyone-error-stand-not-your-turn = You cannot stand during { $player }'s turn. Wait until the turn reaches you.
twentyone-error-stand-no-active-turn = You cannot stand because 21 has no active turn right now.
twentyone-error-play-change-card-between-rounds = You cannot play a Change Card right now because the current round is resolving or the next round has not started yet.
twentyone-error-play-change-card-eliminated = You cannot play a Change Card because you have been eliminated from this match.
twentyone-error-play-change-card-not-your-turn = You cannot play a Change Card during { $player }'s turn. Wait until the turn reaches you.
twentyone-error-play-change-card-no-active-turn = You cannot play a Change Card because 21 has no active turn right now.
twentyone-error-no-change-cards = You cannot play a Change Card because you do not have any Change Cards.
...
twentyone-unplayable-no-valid-target = no opponent can be legally targeted by this Change Card right now.
...
twentyone-modifier-help-shared-cache = Change is good: you and one chosen opponent each gain 1 change card.
...
twentyone-modifier-help-all-in-silence = Game over: while active, your damage and the chosen opponent's damage are both increased by 100, and that opponent cannot draw number cards.
...
twentyone-read-bet-response = Current bets. { $bets }.
...
twentyone-active-effects-all = Active effects. { $lines }.
twentyone-effect-targeted = { $effect } on { $target }
...
twentyone-round-totals = Round totals: { $totals }, target { $target }.
twentyone-you-win-round = You win the round.
twentyone-player-wins-round = { $player } wins the round.
twentyone-round-draw-damage = Round is a draw. Every player takes damage equal to their current bet.
twentyone-both-busted-closer = Everyone busted. Closest to target wins.
