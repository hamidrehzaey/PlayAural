...
\* \*\*Karma Rule:\*\* Whether karma cards and shunning are used. If an attacker and target both still have karma, the attack is neutralized and both sides lose karma. A side that has lost karma can only attack another side that has also lost karma. Requires at least 3 cars or teams (default off).
